package com.ccarlos.usercenter.util;
...
//        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1NjU1OTQ1NjIsImV4cCI6MTU2NjgwNDE2Mn0.PAvWPcQAZnSlYKNbZr4O1l9aA4LPphuq0OG2QIs7O5E\n";
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1OTE3ODMwOTUsImV4cCI6MTU5Mjk5MjY5NX0.8IJE-XlFlLS5Xzu0kykdQZEa952GCp-vRcDG9-oLiSE";
        // 测试2: 如果能token合法且未过期，返回true
        Boolean validateToken = jwtOperator.validateToken(someToken);
        System.out.println("2.validateToken:"+validateToken);
//
//        // 测试3: 获取用户信息
        Claims claims = jwtOperator.getClaimsFromToken(someToken);
        System.out.println("3.claims:"+claims);
//
//        // 将我改成你生成的token的第一段（以.为边界）
        String encodedHeader = "eyJhbGciOiJIUzI1NiJ9";
        // 测试4: 解密Header
        byte[] header = Base64.decodeBase64(encodedHeader.getBytes());
        System.out.println("4.header"+new String(header));
//
        // 将我改成你生成的token的第二段（以.为边界）
//        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1NjU1ODk1NDEsImV4cCI6MTU2Njc5OTE0MX0";
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1OTIzODYwNDgsImV4cCI6MTU5MzU5NTY0OH0";

        // 测试5: 解密Payload
        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
        System.out.println("5.payload:"+new String(payload));
//
//        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
        System.out.println(jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1OTIzODYwNzUsImV4cCI6MTU5MzU5NTY3NX0.ubqF8hvBhlDUoK61nS4CvjCDBSgHVL1xQRdPcQqygu0"));
//    }
    }
}